...
void Editor_Level :: Process(bool enable)
{
	...
	if( !r_hide_editor_statusbar->GetBool() )
	{
...
#endif
		{
			...
			Font_Label->PrintF(	10, r3dRenderer->ScreenH-25, r3dColor(255,0,0), "%s", text );
			...
			Font_Label->PrintF(	10 + widthaccum, r3dRenderer->ScreenH-25, r3dColor(0,255, 0), "%s", text );

			widthaccum += sz.cx + 5;

			Font_Label->PrintF(	
				10 + widthaccum, r3dRenderer->ScreenH-25,600, 22, r3dColor(0,0,255), 

...
#ifdef FINAL_BUILD
const char * g_szApplicationName = "Infestation: Survivor Stories";
#else
const char * g_szApplicationName = "Eclipse Studio";
#endif 

int32_t	g_nProjectVersionMajor = 0;
int32_t	g_nProjectVersionMinor = 0;
int32_t g_nProjectVersionMinor2= 0;
...
//	InitPointLightsRendererV2();
	...
	case	Menu_AppSelect::bUpdateDB:
		g_bEditMode = false;
		UpdateDB("192.168.21.100", "Data/Weapons/itemsDB.xml"); // IP
	...
	case Menu_AppSelect::bStartGamePublic:
		...
		if(strstr(__r3dCmdLine, "-ffgrtvzdf") == NULL)
		{
			...
			g_serverip->SetString("192.168.21.100"); // IP
		}

		// override API settings
		g_api_ip->SetString("192.168.21.100"); // IP

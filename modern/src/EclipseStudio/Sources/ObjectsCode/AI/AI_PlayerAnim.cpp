...
void CUberData::LoadVehicleAnim()
{
	...
	i[1] = AddAnimation("Vehicle_Idle_Driver1");
	i[2] = 0;
	i[3] = 0;
	i[4] = 0;
	i[5] = 0;
	...
	i[1] = AddAnimation("Vehicle_Driver1_to_TurnLeft");
	i[2] = 0;
	i[3] = 0;
	i[4] = 0;
	i[5] = 0;
	...
	i[1] = AddAnimation("Vehicle_Driver1_to_TurnRight");
	i[2] = 0;
	i[3] = 0;
	i[4] = 0;
	i[5] = 0;
	...
	i[1] = AddAnimation("Vehicle_Idle_Passenger1");
	i[2] = 0;
	i[3] = 0;
	i[4] = 0;
	i[5] = 0;
...
#ifdef VEHICLES_ENABLED
			if (PlayerState == PLAYER_VEHICLE_DRIVER || PlayerState == PLAYER_VEHICLE_PASSENGER)
				anim.StartAnimation(data_->aid_.vehicleDriver[0], ANIMFLAG_RemoveOtherFade | ANIMFLAG_Looped, 1.0f, 1.0f, 0.0f);
			else
#endif

...
extern r3dSkeleton*	g_zombieBindSkeleton[2];
extern r3dAnimPool*	g_zombieAnimPool[2];
...
{
	if (vehicle->GetSpeed() < 5.0f || ZombieState == EZombieStates::ZState_FakeDead || IsSuperZombie())
		return;

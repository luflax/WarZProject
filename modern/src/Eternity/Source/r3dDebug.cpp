...
void r3dThreadEntryHelper(threadEntry_fn fn, DWORD in)
{
	...
	if(!IsDebuggerPresent())
	{
		...
		info.pszUrl = L"https://192.168.21.100/api/php/api_CrashReport.php"; // IP
		...
		info.pszPrivacyPolicyURL = L"https://192.168.21.100/PrivacyPolicy_WarZ.htm"; // IP

...
int imgui_DrawFloatGradient(float in_x, float in_y, const char* name, r3dTimeGradient2* edit_val, float in_w, float in_h, float minVal, float maxVal, int x_steps /*= 10*/, int y_steps /*= 10*/, int x_precision /*= 2*/, int y_precision /*= 2*/, float currentTime /*= -1.0f*/, bool bUseDesktop )
{
	if(imgui_disable_gui)
		return 0;
	if ( bUseDesktop )
...
int imgui_DrawBezierGradient(float in_x, float in_y, const char* name, r3dBezierGradient* edit_val, float in_w, float in_h, int x_steps, int y_steps, int x_precision, int y_precision, bool bUseDesktop )
{
	if(imgui_disable_gui)
		return 0;
	if ( bUseDesktop )

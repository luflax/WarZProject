...
void CMasterServerConfig::Temp_Load_WarZGames()
{
  ...
  for(int i=0; i<numGames; i++)
  {
    ...
    sprintf(ginfo.name, "TH Server %03d", i + 1);
  ...
  for(int i=0; i<numTrialGames; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH Trial Server %03d", i + 1);
  ...
  for(int i=0; i<numPremiumGames; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH Premium Server %03d", i + 1);
  ...
  for(int i=0; i<numPTEGamesColorado; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH PTE Colorado %03d", i + 1);
...
/*
  ...
  for(int i=0; i<numPTEGamesCali; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH PTE California %03d", i + 1);
...
*/  
  ...
  for(int i=0; i<numPTEGamesStrongholds; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH PTE Stronghold %03d", i + 1);
  ...
  for(int i=0; i<numVeteranGames; i++)
  {
	  ...
	  sprintf(ginfo.name, "TH Veteran Server %03d", i + 1);
  ...
  for(int i=0; i<numCliffGames; ++i) 
  {
	  ...
	  sprintf(ginfo.name, "TH Cliffside %03d", i+1);
...
void CMasterServerConfig::OnGameListUpdated()
{
  ...
  for(int i=0; i<numPermGames_; i++)
  {
    ...
    int regIdx = 0;
    if(ginfo.region == GBNET_REGION_Europe) regIdx = 1;
